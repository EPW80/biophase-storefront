...
if (missingVars.length > 0) {
  throw new Error(
    ...
    'Create a .env.local file with these values. See .env.example for reference.'
  );
}
...
// formatPrice has been moved to lib/formatPrice.js for client-side usage
// without pulling in server-only Shopify API dependencies
